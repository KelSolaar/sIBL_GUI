...
cp ../src/resources/Horizontal_Scrollbar_Grip.png ../releases/Linux/sIBL_GUI/resources
cp ../src/resources/Icon_Light.png ../releases/Linux/sIBL_GUI/resources
cp ../src/resources/Inspect.png ../releases/Linux/sIBL_GUI/resources
cp ../src/resources/Inspect_Active.png ../releases/Linux/sIBL_GUI/resources
cp ../src/resources/Inspect_Hover.png ../releases/Linux/sIBL_GUI/resources
...
cp ../src/resources/Small_Down_Arrow.png ../releases/Linux/sIBL_GUI/resources
