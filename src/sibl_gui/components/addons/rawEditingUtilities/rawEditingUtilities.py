...
__all__ = ["LOGGER", "RawEditingUtilities"]
...
class RawEditingUtilities(UiComponent):
	...
	def addWidget(self):
		...
		self.__factoryPreferencesManager.ui.Others_Preferences_gridLayout.addWidget(self.ui.Custom_Text_Editor_Path_groupBox)
