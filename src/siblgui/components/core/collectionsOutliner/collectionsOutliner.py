...
import siblgui.ui.widgets.messageBox as messageBox
...
class CollectionsOutliner_QTreeView(QTreeView):
	...
	@core.executionTrace
	@foundations.exceptions.exceptionsHandler(siblgui.ui.common.uiBasicExceptionHandler, False, OSError, foundations.exceptions.UserError)
	...
	@core.executionTrace
	@foundations.exceptions.exceptionsHandler(siblgui.ui.common.uiBasicExceptionHandler, False, foundations.exceptions.UserError)
...
class CollectionsOutliner(UiComponent):
	...
	@core.executionTrace
	@foundations.exceptions.exceptionsHandler(siblgui.ui.common.uiBasicExceptionHandler, False, foundations.exceptions.UserError, Exception)
