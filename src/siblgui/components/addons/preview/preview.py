...
import siblgui.libraries.freeImage.freeImage as freeImage
...
class ImagesPreviewer(object):
	...
	def fitPreviewer(self):
		...
		if self.__displayGraphicsItem:
			...
			siblgui.ui.common.centerWidgetOnScreen(self.__ui)
	...
	def setImage(self, index=0):
		...
		if self.__paths:
			...
			image = siblgui.ui.common.getImage(path)
...
class Preview(UiComponent):
	...
	@core.executionTrace
	@foundations.exceptions.exceptionsHandler(siblgui.ui.common.uiBasicExceptionHandler, False, OSError, Exception)
